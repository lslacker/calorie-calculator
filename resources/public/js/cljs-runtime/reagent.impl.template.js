...
var temp__5808__auto___23059 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5808__auto___23059 == null)){
} else {
var key_23060 = temp__5808__auto___23059;
(jsprops.key = key_23060);
}
...
var temp__5808__auto___23061 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___23061 == null)){
} else {
var key_23062 = temp__5808__auto___23061;
...
var temp__5808__auto___23063 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___23063 == null)){
} else {
var key_23064 = temp__5808__auto___23063;
(jsprops.key = key_23064);
}
...
break;
default:
var G__23066 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__23067 = compiler;
v = G__23066;
compiler = G__23067;
continue;
