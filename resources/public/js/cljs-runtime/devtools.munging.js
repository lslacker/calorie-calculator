...
var o12402 = temp__5802__auto__;
var temp__5802__auto____$1 = (o12402["core"]);
if(cljs.core.truth_(temp__5802__auto____$1)){
var o12403 = temp__5802__auto____$1;
return (o12403["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__12134__auto__ = f;
return (o__12134__auto__["toString"]).call(o__12134__auto__);
} else {
return "";
}
}catch (e12413){var _ = e12413;
return "";
}});
...
try{var o__12134__auto___12682 = t;
(o__12134__auto___12682["cljs$lang$ctorPrWriter"]).call(o__12134__auto___12682,t,writer);
}catch (e12427){var __12684 = e12427;
}
...
var char_code = (function (){var o__12134__auto__ = (new String(char$));
return (o__12134__auto__["charCodeAt"]).call(o__12134__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__12134__auto__ = String;
return (o__12134__auto__["fromCharCode"]).call(o__12134__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__12432 = num_code;
switch (G__12432) {
case (1):
return (185);
...
var o__12134__auto__ = String;
return (o__12134__auto__["fromCharCode"]).call(o__12134__auto__,superscript_code);
});
/**
...
}catch (e12459){var _e__12156__auto__ = e12459;
return false;
}})())){
...
var vec__12464 = devtools.munging.parse_fn_source(fn_source);
var name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12464,(0),null);
...
var ns_detector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12489,(0),null);
...
var G__12707 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last(remaining_tokens)], null),name_tokens);
var G__12708 = cljs.core.butlast(remaining_tokens);
name_tokens = G__12707;
remaining_tokens = G__12708;
continue;
}
}
break;
...
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__12487,seq12486__$1);
}));
...
var vec__12494 = cljs.core.split_with((function (p1__12493_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__12493_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12494,(0),null);
var arity_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12494,(1),null);
...
var vec__12500 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(remaining_tokens,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([detector], 0));
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12500,(0),null);
var name_and_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12500,(1),null);
if(cljs.core.empty_QMARK_(protocol_ns)){
var G__12710 = cljs.core.rest(remaining_tokens);
var G__12711 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(name_tokens,cljs.core.first(remaining_tokens));
remaining_tokens = G__12710;
name_tokens = G__12711;
continue;
} else {
...
var vec__12509 = devtools.munging.strip_arity(tokens);
var tokens__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12509,(0),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12509,(1),null);
var vec__12512 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(tokens__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([effective_detector], 0));
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12512,(0),null);
var tokens__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12512,(1),null);
var vec__12515 = devtools.munging.parse_protocol(tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12515,(0),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12515,(1),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12515,(2),null);
var protocol_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12515,(3),null);
...
var vec__12522 = result;
var munged_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12522,(0),null);
var munged_name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12522,(1),null);
var munged_protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12522,(2),null);
var munged_protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12522,(3),null);
var munged_protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12522,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12522,(5),null);
...
if(cljs.core.truth_(temp__5802__auto__)){
var vec__12538 = temp__5802__auto__;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12538,(0),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12538,(1),null);
var vec__12541 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$1(munged_name);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12541,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12541,(1),null);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.take.cljs$core$IFn$_invoke$arity$2((2),fn_info),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),(function (){var G__12546 = cljs.core.second(cljs.core.first(arities));
return (devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1 ? devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1(G__12546) : devtools.munging.parse_fn_info_deep.call(null,G__12546));
})()));
}
} else {
return fn_info;
...
var G__12747 = (arity + (1));
var G__12748 = (function (){var temp__5802__auto__ = devtools.munging.get_fn_fixed_arity(f,arity);
if(cljs.core.truth_(temp__5802__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__12560){
var vec__12562 = p__12560;
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12562,(0),null);
var arity_fn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12562,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__12582_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(arities,p1__12582_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.cljs$core$IFn$_invoke$arity$2(devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__12583_SHARP_){
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),p1__12583_SHARP_);
}),sorted_infos);
...
args__5775__auto__.push((arguments[i__5770__auto___12755]));
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__12587){
var vec__12588 = p__12587;
var humanize_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12588,(0),null);
...
var map__12602 = options;
var map__12602__$1 = cljs.core.__destructure_map(map__12602);
var include_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12602__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12602__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12602__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12602__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__12603 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$2(munged_name,ns_detector);
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12603,(0),null);
var fn_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12603,(1),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12603,(2),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12603,(3),null);
var protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12603,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12603,(5),null);
...
var o__12134__auto__ = f;
return (o__12134__auto__["getBasis"]).call(o__12134__auto__);
});
/**
...
}catch (e12615){var _e__12156__auto__ = e12615;
...
var G__12764 = (obj[cljs.core.first(path)]);
var G__12765 = cljs.core.rest(path);
obj = G__12764;
path = G__12765;
continue;
} else {
...
var _STAR_ = (function (accum,p__12653){
var vec__12654 = p__12653;
var bit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12654,(0),null);
var protocol = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12654,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__12664){
var vec__12665 = p__12664;
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12665,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12665,(1),null);
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12665,(2),null);
...
var post_process = (function (p__12676){
var vec__12677 = p__12676;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12677,(0),null);
var matches__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12677,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__12671_SHARP_){
return (obj[cljs.core.first(p1__12671_SHARP_)]);
}),sorted_matches);
