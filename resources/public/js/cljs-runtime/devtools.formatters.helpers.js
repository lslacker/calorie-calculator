...
var G__12745 = devtools.prefs.pref(v);
v = G__12745;
continue;
} else {
return v;
...
}catch (e12693){var _e__12156__auto__ = e12693;
return false;
}})();
...
}catch (e12695){var _e__12156__auto__ = e12695;
return false;
}})();
...
}catch (e12698){var _e__12156__auto__ = e12698;
return false;
}}
}
});
...
var vec__12712 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12712,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12712,(1),null);
...
return cljs.core.some((function (p1__12721_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__12721_SHARP_);
}),template);
});
