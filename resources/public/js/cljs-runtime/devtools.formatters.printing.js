...
var len__5769__auto___12809 = arguments.length;
var i__5770__auto___12810 = (0);
while(true){
if((i__5770__auto___12810 < len__5769__auto___12809)){
args__5775__auto__.push((arguments[i__5770__auto___12810]));

var G__12811 = (i__5770__auto___12810 + (1));
i__5770__auto___12810 = G__12811;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq12758){
...
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__12759,G__12760,seq12758__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__12785_SHARP_){
return (!((cljs.core.meta(p1__12785_SHARP_) == null)));
})))){
...
}catch (e12799){var _e__12156__auto__ = e12799;
return false;
}})();
if(cljs.core.truth_(or__5045__auto__)){
return or__5045__auto__;
...
}catch (e12801){var _e__12156__auto__ = e12801;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__12803 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__12804 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__12804);
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12805__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__12803);
}});
...
var temp__5802__auto___12822 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5802__auto___12822)){
var managed_print_level_12823 = temp__5802__auto___12822;
var _STAR_print_level_STAR__orig_val__12807_12824 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__12808_12825 = managed_print_level_12823;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__12808_12825);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__12806_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__12806_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__12807_12824);
}} else {
job_fn();
}
