...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__22920 = c;
var G__22920__$1 = (((G__22920 == null))?null:G__22920.prototype);
if((G__22920__$1 == null)){
return null;
} else {
return G__22920__$1.reagentRender;
}
})() == null)))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__22921 = c;
var G__22921__$1 = (((G__22921 == null))?null:G__22921.prototype);
if((G__22921__$1 == null)){
return null;
} else {
return G__22921__$1.render;
}
})() == null)))));
});
...
var G__22977 = c;
var G__22977__$1 = (((G__22977 == null))?null:G__22977.constructor);
if((G__22977__$1 == null)){
return null;
} else {
return G__22977__$1.name;
}
}
});
...
var _STAR_current_component_STAR__orig_val__22983 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__22984 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__22984);

try{return reagent.impl.component.wrap_render(c,compiler);
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__22983);
}});
...
var c = this;
var G__22999_23015 = reagent.impl.component.goog$module$goog$object.get(c,"cljsRatom");
if((G__22999_23015 == null)){
} else {
reagent.ratom.dispose_BANG_(G__22999_23015);
}
...
var renders_23016 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383)], null));
var render_fun_23017 = cljs.core.first(cljs.core.vals(renders_23016));
...
if((cljs.core.count(renders_23016) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_23016))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_23017)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_23017], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var G__23000 = o;
reagent.impl.component.goog$module$goog$object.set(G__23000,cljs.core.name(k),v);
...
return (function() { 
var G__23022__delegate = function (args){
return reagent.impl.protocols.as_element(compiler,cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.vector,res,args));
};
var G__23022 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__23023__i = 0, G__23023__a = new Array(arguments.length -  0);
while (G__23023__i < G__23023__a.length) {G__23023__a[G__23023__i] = arguments[G__23023__i + 0]; ++G__23023__i;}
  args = new cljs.core.IndexedSeq(G__23023__a,0,null);
} 
return G__23022__delegate.call(this,args);};
G__23022.cljs$lang$maxFixedArity = 0;
G__23022.cljs$lang$applyTo = (function (arglist__23024){
var args = cljs.core.seq(arglist__23024);
return G__23022__delegate(args);
});
...
var _STAR_current_component_STAR__orig_val__23001 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__23002 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__23002);

try{return reagent.impl.component.functional_wrap_render(compiler,c);
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__23001);
}});
...
var vec__23003 = module$node_modules$react$index.useState((0));
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23003,(0),null);
var update_count = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23003,(1),null);
...
var G__23006 = reagent.impl.component.goog$module$goog$object.get(reagent_state,"cljsRatom");
if((G__23006 == null)){
return null;
} else {
return reagent.ratom.dispose_BANG_(G__23006);
}
});
}),[]);
